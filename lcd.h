...
#define LCD_RW   (1 << 1)   // P1 (unused)
#define LCD_EN   (1 << 2)   // P2
#define LCD_BL   (1 << 3)   // P3

#define TSU1_US   1   // RS/RW setup before E↑
#define TH1_US    1   // RS/RW hold after E↓
#define TSU2_US   1   // Data setup before E↓
#define TH2_US    1   // Data hold after E↓
